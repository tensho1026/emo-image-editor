...
- JPEG / PNG / WebP のアップロード（1枚または複数枚）
- 複数枚を同じプリセット・強度・詳細調整でまとめて加工
- サムネイルで切り替え、一括保存は ZIP
...
- 編集をリセット（プリセット・強度・詳細調整を初期値に戻す）
- PC は画面を左右に分割してプレビューを見ながら編集
- スマホは上部にプレビューを固定し、下の操作中も画像が見える
- JPEG / PNG ダウンロード
